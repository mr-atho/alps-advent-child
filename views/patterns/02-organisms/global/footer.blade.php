...
<script src="<?php echo get_stylesheet_directory_uri() ; ?>/assets/scripts/jquery-2.2.4.min.js"></script>
<script src="<?php echo get_stylesheet_directory_uri() ; ?>/assets/scripts/script.min.js" type="text/javascript" async></script>
